        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PostedDateAndTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_VoteAnswers_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("02629b35-b8ef-4658-9cee-c0ec06da244f"), "Python" },
                    { new Guid("65aac0d2-e0fa-4e1f-a5d5-ada0913d4eee"), "C++" },
                    { new Guid("6c65ab2b-53e5-4eb3-8911-b75687e542c3"), "Java" },
                    { new Guid("94276b07-a9dc-4460-9642-ab604c7cf2ff"), "C#" }
                });
